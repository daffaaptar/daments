...
if (isset($_GET['id_user'])) {
    ...
    $query = "SELECT * FROM overtime WHERE id_lembur = $id_user";
    ...
    <section class="content"> 
        <div class="container-fluid"> 
            <div class="card"> 
                    ...
                    <table class="table table-bordered table-hover mt-3">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; vertical-align: middle;">Jumlah Lembur</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;"><?php echo convertDateFormat($data['tanggal']); ?></td>
                ...
                <?php else : ?>
                    <p>Tidak ada data aktivitas yang ditemukan untuk ID Lembur <?php echo $id_user; ?></p>
                <?php endif; ?>
                </div>
            </div>
        </div>
